...
export type NgMilkdownPluginConfigAsync =
  (provider: NgProsemirrorAdapterProvider) => Promise<(ctx: Ctx) => void>

export type NgMilkdownPluginConfigSync =
  (provider: NgProsemirrorAdapterProvider) => (ctx: Ctx) => void
